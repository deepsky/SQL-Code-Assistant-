...
public interface PLSqlTypesAdopted {
	...
	PlSqlElementType SET_TRN_STATEMENT = new PlSqlElementType("SET_TRN_STATEMENT", PLSqlTokenTypes.SET_TRN_STATEMENT);
	...
	PlSqlElementType CONSUMED_TILL_EOL = new PlSqlElementType("CONSUMED_TILL_EOL", PLSqlTokenTypes.CONSUMED_TILL_EOL);
	PlSqlElementType FROM_SUBQUERY = new PlSqlElementType("FROM_SUBQUERY", PLSqlTokenTypes.FROM_SUBQUERY);
	PlSqlElementType GRANT_COMMAND = new PlSqlElementType("GRANT_COMMAND", PLSqlTokenTypes.GRANT_COMMAND);
	...
	PlSqlElementType CREATE_MATERIALIZED_VIEW = new PlSqlElementType("CREATE_MATERIALIZED_VIEW", PLSqlTokenTypes.CREATE_MATERIALIZED_VIEW);
	...
	PlSqlElementType SQL_CURSOR_FAKE_ATTR = new PlSqlElementType("SQL_CURSOR_FAKE_ATTR", PLSqlTokenTypes.SQL_CURSOR_FAKE_ATTR);
	...
	PlSqlElementType RENAME_TABLE = new PlSqlElementType("RENAME_TABLE", PLSqlTokenTypes.RENAME_TABLE);
	...
	PlSqlElementType ANSI_JOIN_TAB_CONDITION = new PlSqlElementType("ANSI_JOIN_TAB_CONDITION", PLSqlTokenTypes.ANSI_JOIN_TAB_CONDITION);
	...
	PlSqlElementType SYSTEM_PRIVILEGE = new PlSqlElementType("SYSTEM_PRIVILEGE", PLSqlTokenTypes.SYSTEM_PRIVILEGE);
	...
	PlSqlElementType BUILTIN_FUNC_NAME = new PlSqlElementType("BUILTIN_FUNC_NAME", PLSqlTokenTypes.BUILTIN_FUNC_NAME);
	PlSqlElementType OPEN_STATEMENT = new PlSqlElementType("OPEN_STATEMENT", PLSqlTokenTypes.OPEN_STATEMENT);
	...
	PlSqlElementType ALTER_INDEX = new PlSqlElementType("ALTER_INDEX", PLSqlTokenTypes.ALTER_INDEX);
	PlSqlElementType USER_NAME = new PlSqlElementType("USER_NAME", PLSqlTokenTypes.USER_NAME);
	...
	PlSqlElementType PARTITION_NAME = new PlSqlElementType("PARTITION_NAME", PLSqlTokenTypes.PARTITION_NAME);
	...
	PlSqlElementType USER_ROLE = new PlSqlElementType("USER_ROLE", PLSqlTokenTypes.USER_ROLE);
	...
	PlSqlElementType REVOKE_COMMAND = new PlSqlElementType("REVOKE_COMMAND", PLSqlTokenTypes.REVOKE_COMMAND);
	...
	PlSqlElementType LOCK_TABLE_STATEMENT = new PlSqlElementType("LOCK_TABLE_STATEMENT", PLSqlTokenTypes.LOCK_TABLE_STATEMENT);
