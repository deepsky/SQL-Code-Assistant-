...
public interface PlSqlBaseTokenTypes {
		...
		IElementType KEYWORD_PRIVILEGES = new PlSqlTokenType(826, "PRIVILEGES");
		IElementType KEYWORD_WAIT = new PlSqlTokenType(861, "WAIT");
		IElementType KEYWORD_PCTFREE = new PlSqlTokenType(633, "PCTFREE");
		IElementType KEYWORD_FLOAT = new PlSqlTokenType(754, "FLOAT");
		IElementType KEYWORD_LRTRIM = new PlSqlTokenType(921, "LRTRIM");
		IElementType KEYWORD_MISSING = new PlSqlTokenType(911, "MISSING");
		IElementType KEYWORD_OVER = new PlSqlTokenType(811, "OVER");
		IElementType KEYWORD_REFERENCES = new PlSqlTokenType(467, "REFERENCES");
		IElementType KEYWORD_TIME = new PlSqlTokenType(741, "TIME");
		IElementType KEYWORD_CHARACTERSET = new PlSqlTokenType(890, "CHARACTERSET");
		...
		IElementType KEYWORD_RIGHT = new PlSqlTokenType(847, "RIGHT");
		...
		IElementType KEYWORD_SAVEPOINT = new PlSqlTokenType(872, "SAVEPOINT");
		IElementType KEYWORD_NUMBER = new PlSqlTokenType(732, "NUMBER");
		IElementType KEYWORD_EXTRACT = new PlSqlTokenType(805, "EXTRACT");
		...
		IElementType KEYWORD_BIG = new PlSqlTokenType(892, "BIG");
		IElementType KEYWORD_SERIALLY_REUSABLE = new PlSqlTokenType(770, "SERIALLY_REUSABLE");
		IElementType KEYWORD_NEXTVAL = new PlSqlTokenType(809, "NEXTVAL");
		...
		IElementType KEYWORD_RAISE = new PlSqlTokenType(779, "RAISE");
		IElementType KEYWORD_EXCLUSIVE = new PlSqlTokenType(870, "EXCLUSIVE");
		IElementType KEYWORD_BEFORE = new PlSqlTokenType(582, "BEFORE");
		IElementType KEYWORD_SQLERRM = new PlSqlTokenType(796, "SQLERRM");
		IElementType KEYWORD_NOGUARANTEE = new PlSqlTokenType(546, "NOGUARANTEE");
		IElementType KEYWORD_DEBUG = new PlSqlTokenType(828, "DEBUG");
		...
		IElementType KEYWORD_NOWAIT = new PlSqlTokenType(860, "NOWAIT");
		IElementType KEYWORD_PREPROCESSOR = new PlSqlTokenType(909, "PREPROCESSOR");
		...
		IElementType KEYWORD_CURRENT = new PlSqlTokenType(788, "CURRENT");
		IElementType KEYWORD_LEFT = new PlSqlTokenType(846, "LEFT");
		IElementType KEYWORD_SHUTDOWN = new PlSqlTokenType(584, "SHUTDOWN");
		IElementType KEYWORD_MEMBER = new PlSqlTokenType(794, "MEMBER");
		IElementType KEYWORD_SID = new PlSqlTokenType(843, "SID");
		...
		IElementType KEYWORD_JOIN = new PlSqlTokenType(850, "JOIN");
		IElementType KEYWORD_HOUR = new PlSqlTokenType(807, "HOUR");
		...
		IElementType KEYWORD_EXISTS = new PlSqlTokenType(789, "EXISTS");
		IElementType KEYWORD_HAVING = new PlSqlTokenType(856, "HAVING");
		IElementType KEYWORD_PUBLIC = new PlSqlTokenType(428, "PUBLIC");
		IElementType KEYWORD_ZONE = new PlSqlTokenType(742, "ZONE");
		IElementType KEYWORD_SIZES = new PlSqlTokenType(898, "SIZES");
		...
		IElementType KEYWORD_LEAD = new PlSqlTokenType(802, "LEAD");
		IElementType KEYWORD_BY = new PlSqlTokenType(518, "BY");
		IElementType KEYWORD_LONG = new PlSqlTokenType(474, "LONG");
		IElementType KEYWORD_CLOSE = new PlSqlTokenType(866, "CLOSE");
		IElementType KEYWORD_ANY = new PlSqlTokenType(808, "ANY");
		IElementType KEYWORD_NOBADFILE = new PlSqlTokenType(902, "NOBADFILE");
		...
		IElementType KEYWORD_DELIMITED = new PlSqlTokenType(888, "DELIMITED");
		...
		IElementType KEYWORD_COLLECT = new PlSqlTokenType(838, "COLLECT");
		...
		IElementType KEYWORD_TIMEZONE_HOUR = new PlSqlTokenType(816, "TIMEZONE_HOUR");
		...
		IElementType KEYWORD_DATA_CACHE = new PlSqlTokenType(907, "DATA_CACHE");
		...
		IElementType KEYWORD_LAG = new PlSqlTokenType(801, "LAG");
		IElementType KEYWORD_INDEXTYPES = new PlSqlTokenType(446, "INDEXTYPES");
		IElementType KEYWORD_NAME = new PlSqlTokenType(778, "NAME");
		IElementType KEYWORD_DISABLE = new PlSqlTokenType(460, "DISABLE");
		IElementType KEYWORD_TRIM = new PlSqlTokenType(799, "TRIM");
		IElementType KEYWORD_TYPES = new PlSqlTokenType(444, "TYPES");
		IElementType KEYWORD_RESULT_CACHE = new PlSqlTokenType(774, "RESULT_CACHE");
		IElementType KEYWORD_ALL = new PlSqlTokenType(629, "ALL");
		IElementType KEYWORD_PARALLEL = new PlSqlTokenType(638, "PARALLEL");
		IElementType KEYWORD_NODISCARDFILE = new PlSqlTokenType(904, "NODISCARDFILE");
		...
		IElementType KEYWORD_ORACLE_LOADER = new PlSqlTokenType(873, "ORACLE_LOADER");
		IElementType KEYWORD_UNIFORM = new PlSqlTokenType(542, "UNIFORM");
		IElementType KEYWORD_AT = new PlSqlTokenType(787, "AT");
		...
		IElementType KEYWORD_FLUSH = new PlSqlTokenType(840, "FLUSH");
		IElementType KEYWORD_CASCADE = new PlSqlTokenType(419, "CASCADE");
		IElementType KEYWORD_OFF = new PlSqlTokenType(499, "OFF");
		IElementType KEYWORD_JAVA = new PlSqlTokenType(777, "JAVA");
		IElementType KEYWORD_DISABLED = new PlSqlTokenType(884, "DISABLED");
		IElementType KEYWORD_MULTISET = new PlSqlTokenType(800, "MULTISET");
		IElementType KEYWORD_ENCLOSED = new PlSqlTokenType(917, "ENCLOSED");
		...
		IElementType KEYWORD_FIXED = new PlSqlTokenType(887, "FIXED");
		IElementType KEYWORD_OF = new PlSqlTokenType(597, "OF");
		IElementType KEYWORD_REWRITE = new PlSqlTokenType(695, "REWRITE");
		IElementType KEYWORD_RANK = new PlSqlTokenType(803, "RANK");
		IElementType KEYWORD_BYTE = new PlSqlTokenType(737, "BYTE");
		IElementType KEYWORD_RESET = new PlSqlTokenType(842, "RESET");
		...
		IElementType KEYWORD_786 = new PlSqlTokenType(786, "**"); // KEYWORD_**
		IElementType KEYWORD_LIMIT = new PlSqlTokenType(658, "LIMIT");
		IElementType KEYWORD_FETCH = new PlSqlTokenType(867, "FETCH");
		...
		IElementType KEYWORD_VARRAWC = new PlSqlTokenType(934, "VARRAWC");
		...
		IElementType KEYWORD_NEWLINE = new PlSqlTokenType(889, "NEWLINE");
		IElementType KEYWORD_NOORDER = new PlSqlTokenType(578, "NOORDER");
		IElementType KEYWORD_ENDIAN = new PlSqlTokenType(894, "ENDIAN");
		IElementType KEYWORD_SESSION = new PlSqlTokenType(832, "SESSION");
		IElementType KEYWORD_THEN = new PlSqlTokenType(727, "THEN");
		IElementType KEYWORD_MONTH = new PlSqlTokenType(744, "MONTH");
		IElementType KEYWORD_RECORDS = new PlSqlTokenType(886, "RECORDS");
		...
		IElementType KEYWORD_SQLCODE = new PlSqlTokenType(795, "SQLCODE");
		IElementType KEYWORD_MERGE = new PlSqlTokenType(862, "MERGE");
		...
		IElementType KEYWORD_ROWNUM = new PlSqlTokenType(854, "ROWNUM");
		IElementType KEYWORD_AUTOEXTEND = new PlSqlTokenType(547, "AUTOEXTEND");
		IElementType KEYWORD_ZONED = new PlSqlTokenType(928, "ZONED");
		IElementType KEYWORD_HIERARCHY = new PlSqlTokenType(827, "HIERARCHY");
		...
		IElementType KEYWORD_TRUE = new PlSqlTokenType(784, "TRUE");
		IElementType KEYWORD_LDTRIM = new PlSqlTokenType(940, "LDTRIM");
		IElementType KEYWORD_SQL = new PlSqlTokenType(716, "SQL");
		IElementType KEYWORD_DISCARDFILE = new PlSqlTokenType(905, "DISCARDFILE");
		...
		IElementType KEYWORD_TIMEZONE_REGION = new PlSqlTokenType(818, "TIMEZONE_REGION");
		IElementType KEYWORD_LAST = new PlSqlTokenType(859, "LAST");
		IElementType KEYWORD_COUNT = new PlSqlTokenType(725, "COUNT");
		IElementType KEYWORD_SECOND = new PlSqlTokenType(746, "SECOND");
		IElementType KEYWORD_SAVE = new PlSqlTokenType(780, "SAVE");
		IElementType KEYWORD_LOCATION = new PlSqlTokenType(938, "LOCATION");
		IElementType KEYWORD_CHAR = new PlSqlTokenType(736, "CHAR");
		IElementType KEYWORD_SEGMENT = new PlSqlTokenType(622, "SEGMENT");
		IElementType KEYWORD_WHERE = new PlSqlTokenType(852, "WHERE");
		...
		IElementType KEYWORD_RETURNING = new PlSqlTokenType(864, "RETURNING");
		...
		IElementType KEYWORD_MINUS = new PlSqlTokenType(836, "MINUS");
		IElementType KEYWORD_TRAILING = new PlSqlTokenType(821, "TRAILING");
		...
		IElementType KEYWORD_INTERSECT = new PlSqlTokenType(835, "INTERSECT");
		...
		IElementType KEYWORD_IF = new PlSqlTokenType(824, "IF");
		...
		IElementType KEYWORD_VARRAW = new PlSqlTokenType(932, "VARRAW");
		IElementType KEYWORD_MATCHED = new PlSqlTokenType(863, "MATCHED");
		IElementType KEYWORD_VARRAY = new PlSqlTokenType(686, "VARRAY");
		IElementType KEYWORD_NULLS = new PlSqlTokenType(857, "NULLS");
		...
		IElementType KEYWORD_WHITESPACE = new PlSqlTokenType(919, "WHITESPACE");
		...
		IElementType KEYWORD_OPTIONALLY = new PlSqlTokenType(920, "OPTIONALLY");
		...
		IElementType KEYWORD_DBTIMEZONE = new PlSqlTokenType(813, "DBTIMEZONE");
		IElementType KEYWORD_SYSTEM = new PlSqlTokenType(447, "SYSTEM");
		IElementType KEYWORD_DECODE = new PlSqlTokenType(798, "DECODE");
		IElementType KEYWORD_LEADING = new PlSqlTokenType(820, "LEADING");
		...
		IElementType KEYWORD_LOAD = new PlSqlTokenType(901, "LOAD");
		...
		IElementType KEYWORD_ORACLE_DATAPUMP = new PlSqlTokenType(874, "ORACLE_DATAPUMP");
		IElementType KEYWORD_NEXT = new PlSqlTokenType(535, "NEXT");
		IElementType KEYWORD_CLOB = new PlSqlTokenType(762, "CLOB");
		IElementType KEYWORD_DATA = new PlSqlTokenType(891, "DATA");
		...
		IElementType KEYWORD_ORACLE_NUMBER = new PlSqlTokenType(930, "ORACLE_NUMBER");
		...
		IElementType KEYWORD_ELSIF = new PlSqlTokenType(825, "ELSIF");
		...
		IElementType KEYWORD_CURRVAL = new PlSqlTokenType(810, "CURRVAL");
		IElementType KEYWORD_VARCHAR2 = new PlSqlTokenType(757, "VARCHAR2");
		IElementType KEYWORD_BULK = new PlSqlTokenType(837, "BULK");
		IElementType KEYWORD_ALTER = new PlSqlTokenType(414, "ALTER");
		IElementType KEYWORD_FIELD = new PlSqlTokenType(912, "FIELD");
		IElementType KEYWORD_REPLACE = new PlSqlTokenType(508, "REPLACE");
		IElementType KEYWORD_ORACLE_DATE = new PlSqlTokenType(929, "ORACLE_DATE");
		IElementType KEYWORD_NOPARALLEL = new PlSqlTokenType(639, "NOPARALLEL");
		IElementType KEYWORD_ADMIN = new PlSqlTokenType(829, "ADMIN");
		IElementType KEYWORD_STRING = new PlSqlTokenType(897, "STRING");
		IElementType KEYWORD_UNUSABLE = new PlSqlTokenType(845, "UNUSABLE");
		IElementType KEYWORD_PROMPT = new PlSqlTokenType(491, "PROMPT");
		IElementType KEYWORD_VARIABLE = new PlSqlTokenType(477, "VARIABLE");
		IElementType KEYWORD_SHARED_POOL = new PlSqlTokenType(841, "SHARED_POOL");
		...
		IElementType KEYWORD_BOTH = new PlSqlTokenType(822, "BOTH");
		IElementType KEYWORD_INNER = new PlSqlTokenType(848, "INNER");
		IElementType KEYWORD_SYNONYM = new PlSqlTokenType(429, "SYNONYM");
		IElementType KEYWORD_BECOME = new PlSqlTokenType(833, "BECOME");
		IElementType KEYWORD_NOLOGFILE = new PlSqlTokenType(877, "NOLOGFILE");
		IElementType KEYWORD_IDENTIFIED = new PlSqlTokenType(517, "IDENTIFIED");
		IElementType KEYWORD_AFTER = new PlSqlTokenType(581, "AFTER");
		IElementType KEYWORD_TIMEZONE = new PlSqlTokenType(936, "TIMEZONE");
		...
		IElementType KEYWORD_SESSIONTIMEZONE = new PlSqlTokenType(812, "SESSIONTIMEZONE");
		IElementType KEYWORD_LDRTRIM = new PlSqlTokenType(925, "LDRTRIM");
		IElementType KEYWORD_PARAMETERS = new PlSqlTokenType(876, "PARAMETERS");
		IElementType KEYWORD_FIELDS = new PlSqlTokenType(910, "FIELDS");
		IElementType KEYWORD_DEMAND = new PlSqlTokenType(701, "DEMAND");
		IElementType KEYWORD_ENABLED = new PlSqlTokenType(883, "ENABLED");
		...
		IElementType KEYWORD_TIMEZONE_MINUTE = new PlSqlTokenType(817, "TIMEZONE_MINUTE");
		IElementType KEYWORD_SELECT = new PlSqlTokenType(790, "SELECT");
		...
		IElementType KEYWORD_CAST = new PlSqlTokenType(797, "CAST");
		...
		IElementType KEYWORD_TIMEZONE_ABBR = new PlSqlTokenType(819, "TIMEZONE_ABBR");
		...
		IElementType KEYWORD_COMPATIBLE = new PlSqlTokenType(880, "COMPATIBLE");
		IElementType KEYWORD_DATE_FORMAT = new PlSqlTokenType(935, "DATE_FORMAT");
		IElementType KEYWORD_REBUILD = new PlSqlTokenType(844, "REBUILD");
		...
		IElementType KEYWORD_LOGFILE = new PlSqlTokenType(878, "LOGFILE");
		IElementType KEYWORD_LOBFILE = new PlSqlTokenType(916, "LOBFILE");
		...
		IElementType KEYWORD_COUNTED = new PlSqlTokenType(931, "COUNTED");
		IElementType KEYWORD_OPERATIONS = new PlSqlTokenType(631, "OPERATIONS");
		IElementType KEYWORD_LATEST = new PlSqlTokenType(881, "LATEST");
		...
		IElementType KEYWORD_AGGREGATE = new PlSqlTokenType(939, "AGGREGATE");
		...
		IElementType KEYWORD_DISTINCT = new PlSqlTokenType(814, "DISTINCT");
		IElementType KEYWORD_OPEN = new PlSqlTokenType(871, "OPEN");
		IElementType KEYWORD_ARE = new PlSqlTokenType(913, "ARE");
		...
		IElementType KEYWORD_FALSE = new PlSqlTokenType(785, "FALSE");
		IElementType KEYWORD_COMPRESSION = new PlSqlTokenType(882, "COMPRESSION");
		...
		IElementType KEYWORD_LIKE = new PlSqlTokenType(791, "LIKE");
		...
		IElementType KEYWORD_INDICES = new PlSqlTokenType(783, "INDICES");
		IElementType KEYWORD_LANGUAGE = new PlSqlTokenType(776, "LANGUAGE");
		IElementType KEYWORD_POSITION = new PlSqlTokenType(926, "POSITION");
		IElementType KEYWORD_NOTRIM = new PlSqlTokenType(922, "NOTRIM");
		IElementType KEYWORD_BYTES = new PlSqlTokenType(899, "BYTES");
		...
		IElementType KEYWORD_NOCHECK = new PlSqlTokenType(896, "NOCHECK");
		IElementType KEYWORD_OFFLINE = new PlSqlTokenType(553, "OFFLINE");
		IElementType KEYWORD_ESCAPE = new PlSqlTokenType(792, "ESCAPE");
		IElementType KEYWORD_VERSION = new PlSqlTokenType(879, "VERSION");
		IElementType KEYWORD_MODE = new PlSqlTokenType(868, "MODE");
		IElementType KEYWORD_CHARACTER = new PlSqlTokenType(760, "CHARACTER");
		IElementType KEYWORD_BADFILE = new PlSqlTokenType(903, "BADFILE");
		IElementType KEYWORD_EXCEPTIONS = new PlSqlTokenType(781, "EXCEPTIONS");
		IElementType KEYWORD_DEF = new PlSqlTokenType(489, "DEF");
		IElementType KEYWORD_UNION = new PlSqlTokenType(834, "UNION");
		...
		IElementType KEYWORD_UNSIGNED = new PlSqlTokenType(927, "UNSIGNED");
		IElementType KEYWORD_ACCESS = new PlSqlTokenType(875, "ACCESS");
		IElementType KEYWORD_TRANSFORMS = new PlSqlTokenType(914, "TRANSFORMS");
		IElementType KEYWORD_CURRENT_TIMESTAMP = new PlSqlTokenType(853, "CURRENT_TIMESTAMP");
		IElementType KEYWORD_DEGREE = new PlSqlTokenType(655, "DEGREE");
		IElementType KEYWORD_DIRECTORY = new PlSqlTokenType(433, "DIRECTORY");
		IElementType KEYWORD_TERMINATED = new PlSqlTokenType(918, "TERMINATED");
		IElementType KEYWORD_RELIES_ON = new PlSqlTokenType(775, "RELIES_ON");
		...
		IElementType KEYWORD_TRANSACTION = new PlSqlTokenType(865, "TRANSACTION");
		...
		IElementType KEYWORD_MASK = new PlSqlTokenType(937, "MASK");
		IElementType KEYWORD_LITTLE = new PlSqlTokenType(893, "LITTLE");
		IElementType KEYWORD_SHOW = new PlSqlTokenType(475, "SHOW");
		IElementType KEYWORD_SKIP = new PlSqlTokenType(908, "SKIP");
		...
		IElementType KEYWORD_MINUTE = new PlSqlTokenType(806, "MINUTE");
		IElementType KEYWORD_SHARE = new PlSqlTokenType(869, "SHARE");
		IElementType KEYWORD_QUOTA = new PlSqlTokenType(522, "QUOTA");
		IElementType KEYWORD_ORDER = new PlSqlTokenType(577, "ORDER");
		IElementType KEYWORD_FULL = new PlSqlTokenType(851, "FULL");
		IElementType KEYWORD_LTRIM = new PlSqlTokenType(923, "LTRIM");
		...
		IElementType KEYWORD_THE = new PlSqlTokenType(855, "THE");
		...
		IElementType KEYWORD_OUTER = new PlSqlTokenType(849, "OUTER");
		...
		IElementType KEYWORD_FIRST = new PlSqlTokenType(858, "FIRST");
