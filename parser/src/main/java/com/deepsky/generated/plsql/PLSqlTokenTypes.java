...
public interface PLSqlTokenTypes {
	...
	int LITERAL_id = 693;
	int LITERAL_rowid = 694;
	int LITERAL_query = 695;
	int LITERAL_rewrite = 696;
	int LITERAL_never = 697;
	int LITERAL_refresh = 698;
	int LITERAL_build = 699;
	int LITERAL_fast = 700;
	int LITERAL_complete = 701;
	int LITERAL_demand = 702;
	// "view_column_def_$internal$" = 703
	int LITERAL_timestamp = 704;
	int LITERAL_authid = 705;
	int LITERAL_wrapped = 706;
	int LITERAL_pragma = 707;
	int LITERAL_restrict_references = 708;
	int LITERAL_interface = 709;
	int LITERAL_builtin = 710;
	int LITERAL_fipsflag = 711;
	int LITERAL_exception_init = 712;
	int LITERAL_constant = 713;
	int LITERAL_subtype = 714;
	int LITERAL_loop = 715;
	int LITERAL_while = 716;
	int LITERAL_sql = 717;
	int LITERAL_found = 718;
	int LITERAL_notfound = 719;
	int LITERAL_rowcount = 720;
	int LITERAL_isopen = 721;
	int LITERAL_bulk_rowcount = 722;
	int LITERAL_bulk_exceptions = 723;
	int LITERAL_error_index = 724;
	int LITERAL_error_code = 725;
	int LITERAL_count = 726;
	int LITERAL_case = 727;
	int LITERAL_then = 728;
	int LITERAL_else = 729;
	int LITERAL_autonomous_transaction = 730;
	int LITERAL_prior = 731;
	int LITERAL_goto = 732;
	int LITERAL_number = 733;
	int LITERAL_binary_integer = 734;
	int LITERAL_natural = 735;
	int LITERAL_positive = 736;
	int LITERAL_char = 737;
	int LITERAL_byte = 738;
	int LITERAL_raw = 739;
	int LITERAL_boolean = 740;
	int LITERAL_date = 741;
	int LITERAL_time = 742;
	int LITERAL_zone = 743;
	int LITERAL_year = 744;
	int LITERAL_month = 745;
	int LITERAL_day = 746;
	int LITERAL_second = 747;
	int LITERAL_smallint = 748;
	int LITERAL_real = 749;
	int LITERAL_numeric = 750;
	int LITERAL_int = 751;
	int LITERAL_integer = 752;
	int LITERAL_pls_integer = 753;
	int LITERAL_double = 754;
	int LITERAL_float = 755;
	int LITERAL_decimal = 756;
	int LITERAL_varchar = 757;
	// "varchar2" = 758
	int LITERAL_nvarchar = 759;
	// "nvarchar2" = 760
	int LITERAL_character = 761;
	int LITERAL_blob = 762;
	int LITERAL_clob = 763;
	int LITERAL_nclob = 764;
	int LITERAL_bfile = 765;
	int LITERAL_out = 766;
	int LITERAL_nocopy = 767;
	int LITERAL_any_cs = 768;
	int LITERAL_charset = 769;
	int LITERAL_exception = 770;
	int LITERAL_serially_reusable = 771;
	int LITERAL_pipelined = 772;
	int LITERAL_parallel_enable = 773;
	int LITERAL_deterministic = 774;
	int LITERAL_language = 775;
	int LITERAL_java = 776;
	int LITERAL_name = 777;
	int LITERAL_raise = 778;
	int LITERAL_save = 779;
	int LITERAL_exceptions = 780;
	int LITERAL_forall = 781;
	int LITERAL_indices = 782;
	int LITERAL_true = 783;
	int LITERAL_false = 784;
	// "**" = 785
	int LITERAL_at = 786;
	int LITERAL_current = 787;
	int LITERAL_exists = 788;
	int LITERAL_select = 789;
	int LITERAL_like = 790;
	int LITERAL_escape = 791;
	int LITERAL_between = 792;
	int LITERAL_member = 793;
	int LITERAL_sqlcode = 794;
	int LITERAL_sqlerrm = 795;
	int LITERAL_cast = 796;
	int LITERAL_decode = 797;
	int LITERAL_trim = 798;
	int LITERAL_multiset = 799;
	int LITERAL_lag = 800;
	int LITERAL_lead = 801;
	int LITERAL_rank = 802;
	int LITERAL_dense_rank = 803;
	int LITERAL_extract = 804;
	int LITERAL_minute = 805;
	int LITERAL_hour = 806;
	int LITERAL_any = 807;
	int LITERAL_nextval = 808;
	int LITERAL_currval = 809;
	int LITERAL_over = 810;
	int LITERAL_sessiontimezone = 811;
	int LITERAL_dbtimezone = 812;
	int LITERAL_distinct = 813;
	int LITERAL_from = 814;
	int LITERAL_timezone_hour = 815;
	int LITERAL_timezone_minute = 816;
	int LITERAL_timezone_region = 817;
	int LITERAL_timezone_abbr = 818;
	int LITERAL_leading = 819;
	int LITERAL_trailing = 820;
	int LITERAL_both = 821;
	int LITERAL_work = 822;
	int LITERAL_if = 823;
	int LITERAL_elsif = 824;
	int LITERAL_privileges = 825;
	int LITERAL_hierarchy = 826;
	int LITERAL_debug = 827;
	int LITERAL_admin = 828;
	int LITERAL_resource = 829;
	int LITERAL_indextype = 830;
	int LITERAL_session = 831;
	int LITERAL_become = 832;
	int LITERAL_union = 833;
	int LITERAL_intersect = 834;
	int LITERAL_minus = 835;
	int LITERAL_bulk = 836;
	int LITERAL_collect = 837;
	int LITERAL_into = 838;
	int LITERAL_flush = 839;
	int LITERAL_shared_pool = 840;
	int LITERAL_reset = 841;
	int LITERAL_sid = 842;
	int LITERAL_rebuild = 843;
	int LITERAL_unusable = 844;
	int LITERAL_left = 845;
	int LITERAL_right = 846;
	int LITERAL_inner = 847;
	int LITERAL_outer = 848;
	int LITERAL_join = 849;
	int LITERAL_full = 850;
	int LITERAL_where = 851;
	int LITERAL_current_timestamp = 852;
	int LITERAL_rownum = 853;
	int LITERAL_the = 854;
	int LITERAL_having = 855;
	int LITERAL_nulls = 856;
	int LITERAL_first = 857;
	int LITERAL_last = 858;
	int LITERAL_nowait = 859;
	int LITERAL_wait = 860;
	int LITERAL_merge = 861;
	int LITERAL_matched = 862;
	int LITERAL_returning = 863;
	int LITERAL_transaction = 864;
	int LITERAL_close = 865;
	int LITERAL_fetch = 866;
	int LITERAL_mode = 867;
	int LITERAL_share = 868;
	int LITERAL_exclusive = 869;
	int LITERAL_open = 870;
	int LITERAL_savepoint = 871;
	int LITERAL_oracle_loader = 872;
	int LITERAL_oracle_datapump = 873;
	int LITERAL_access = 874;
	int LITERAL_parameters = 875;
	int LITERAL_nologfile = 876;
	int LITERAL_logfile = 877;
	int LITERAL_version = 878;
	int LITERAL_compatible = 879;
	int LITERAL_latest = 880;
	int LITERAL_compression = 881;
	int LITERAL_enabled = 882;
	int LITERAL_disabled = 883;
	int LITERAL_encryption = 884;
	int LITERAL_records = 885;
	int LITERAL_fixed = 886;
	int LITERAL_delimited = 887;
	int LITERAL_newline = 888;
	int LITERAL_characterset = 889;
	int LITERAL_data = 890;
	int LITERAL_big = 891;
	int LITERAL_little = 892;
	int LITERAL_endian = 893;
	int LITERAL_mark = 894;
	int LITERAL_nocheck = 895;
	int LITERAL_string = 896;
	int LITERAL_sizes = 897;
	int LITERAL_bytes = 898;
	int LITERAL_characters = 899;
	int LITERAL_load = 900;
	int LITERAL_nobadfile = 901;
	int LITERAL_badfile = 902;
	int LITERAL_nodiscardfile = 903;
	int LITERAL_discardfile = 904;
	int LITERAL_readsize = 905;
	int LITERAL_data_cache = 906;
	int LITERAL_skip = 907;
	int LITERAL_preprocessor = 908;
	int LITERAL_fields = 909;
	int LITERAL_missing = 910;
	int LITERAL_field = 911;
	int LITERAL_are = 912;
	int LITERAL_transforms = 913;
	int LITERAL_concat = 914;
	int LITERAL_lobfile = 915;
	int LITERAL_enclosed = 916;
	int LITERAL_terminated = 917;
	int LITERAL_whitespace = 918;
	int LITERAL_optionally = 919;
	int LITERAL_lrtrim = 920;
	int LITERAL_notrim = 921;
	int LITERAL_ltrim = 922;
	int LITERAL_rtrim = 923;
	int LITERAL_ldrtrim = 924;
	int LITERAL_position = 925;
	int LITERAL_unsigned = 926;
	int LITERAL_zoned = 927;
	int LITERAL_oracle_date = 928;
	int LITERAL_oracle_number = 929;
	int LITERAL_counted = 930;
	int LITERAL_varraw = 931;
	int LITERAL_varcharc = 932;
	int LITERAL_varrawc = 933;
	int LITERAL_date_format = 934;
	int LITERAL_timezone = 935;
	int LITERAL_mask = 936;
	int LITERAL_location = 937;
	int LITERAL_aggregate = 938;
	int LITERAL_ldtrim = 939;
}
