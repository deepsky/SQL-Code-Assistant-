...
public class TNSLexer extends antlr.CharScanner implements TNSTokenTypes, TokenStream
 {
public TNSLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public TNSLexer(Reader in) {
	this(new CharBuffer(in));
}
public TNSLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public TNSLexer(LexerSharedInputState state) {
	super(state);
