package com.deepsky.tools.jsch;
...
public class PortForwardingL{
   public static void main(String[] arg){
      ...
      try{
         ...
         String foo=JOptionPane.showInputDialog(
               "Enter -L port:host:hostport",
               "3521:qaitdora1.pts.sita.aero:1521");
