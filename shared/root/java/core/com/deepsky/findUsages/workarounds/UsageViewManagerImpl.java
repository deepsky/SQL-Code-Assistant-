...
public class UsageViewManagerImpl extends UsageViewManager {
  ...
  public UsageView createUsageView(@NotNull UsageTarget[] targets, @NotNull Usage[] usages, @NotNull UsageViewPresentation presentation, Factory<UsageSearcher> usageSearcherFactory) {
    UsageView2Impl usageView = new UsageView2Impl(myProject, presentation, targets, usageSearcherFactory);
  ...
  public UsageView showUsages(@NotNull UsageTarget[] searchedFor, @NotNull Usage[] foundUsages, @NotNull UsageViewPresentation presentation, Factory<UsageSearcher> factory) {
    ...
    addContent((UsageView2Impl)usageView, presentation);
    showToolWindow(true);
    return usageView;
  }
  ...
  private void addContent(UsageView2Impl usageView, UsageViewPresentation presentation) {
  ...
  private static void appendUsages(@NotNull final Usage[] foundUsages, final UsageView2Impl usageView) {
  ...
  private class SearchForUsagesRunnable implements Runnable {
    ...
    private final AtomicReference<UsageView2Impl> myUsageViewRef;
    ...
    private SearchForUsagesRunnable(@NotNull final AtomicReference<UsageView2Impl> usageView,
    ...
    private UsageView2Impl getUsageView() {
      UsageView2Impl usageView = myUsageViewRef.get();
      ...
      if (usageCount >= 2 || usageCount == 1 && myProcessPresentation.isShowPanelIfOnlyOneUsage()) {
        usageView = new UsageView2Impl(myProject, myPresentation, mySearchFor, mySearcherFactory);
    ...
    private void openView(final UsageView2Impl usageView) {
    ...
    private void searchUsages() {
      ...
      usageSearcher.generate(new Processor<Usage>() {
        public boolean process(final Usage usage) {
          ...
          UsageView2Impl usageView = getUsageView();
          if (usageView != null) {
    ...
    private void endSearchForUsages() {
      ...
      if (usageCount == 0 && myProcessPresentation.isShowNotFoundMessage()) {
        ...
        final UsageView2Impl usageView = myUsageViewRef.get();
  ...
  private static void flashUsageScriptaculously(final Usage usage) {
    ...
    // todo -- idea 106.491 rangeBlinker.resetMarkers(usageInfo.getRangeMarkers());
