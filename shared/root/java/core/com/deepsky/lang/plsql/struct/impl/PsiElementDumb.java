...
public abstract class PsiElementDumb implements PlSqlElement {
    ...
    IElementType etype;
    public PsiElementDumb(IElementType etype){
        this.etype = etype;
    }

    public PsiElementDumb(){
    }
    ...
    public ASTNode getNode() {
        InvocationHandler astNodeHandler = new InvocationHandler() {
        ...
        return (ASTNode) Proxy.newProxyInstance(
