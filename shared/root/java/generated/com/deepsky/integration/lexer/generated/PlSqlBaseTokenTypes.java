...
public interface PlSqlBaseTokenTypes {
		...
		IElementType KEYWORD_LRTRIM = new PlSqlTokenType(822, "LRTRIM");
		IElementType KEYWORD_MISSING = new PlSqlTokenType(820, "MISSING");
		...
		IElementType KEYWORD_CHARACTERSET = new PlSqlTokenType(800, "CHARACTERSET");
		...
		IElementType KEYWORD_BIG = new PlSqlTokenType(801, "BIG");
		...
		IElementType KEYWORD_PREPROCESSOR = new PlSqlTokenType(841, "PREPROCESSOR");
		...
		IElementType KEYWORD_SIZES = new PlSqlTokenType(807, "SIZES");
		...
		IElementType KEYWORD_NOBADFILE = new PlSqlTokenType(810, "NOBADFILE");
		...
		IElementType KEYWORD_DELIMITED = new PlSqlTokenType(798, "DELIMITED");
		...
		IElementType KEYWORD_DATA_CACHE = new PlSqlTokenType(818, "DATA_CACHE");
		...
		IElementType KEYWORD_NAME = new PlSqlTokenType(712, "NAME");
		...
		IElementType KEYWORD_NODISCARDFILE = new PlSqlTokenType(812, "NODISCARDFILE");
		...
		IElementType KEYWORD_OFF = new PlSqlTokenType(447, "OFF");
		IElementType KEYWORD_JAVA = new PlSqlTokenType(711, "JAVA");
		IElementType KEYWORD_DISABLED = new PlSqlTokenType(844, "DISABLED");
		IElementType KEYWORD_MULTISET = new PlSqlTokenType(734, "MULTISET");
		IElementType KEYWORD_ENCLOSED = new PlSqlTokenType(828, "ENCLOSED");
		...
		IElementType KEYWORD_FIXED = new PlSqlTokenType(799, "FIXED");
		...
		IElementType KEYWORD_VARRAWC = new PlSqlTokenType(832, "VARRAWC");
		...
		IElementType KEYWORD_NEWLINE = new PlSqlTokenType(797, "NEWLINE");
		IElementType KEYWORD_NOORDER = new PlSqlTokenType(512, "NOORDER");
		IElementType KEYWORD_ENDIAN = new PlSqlTokenType(803, "ENDIAN");
		...
		IElementType KEYWORD_RECORDS = new PlSqlTokenType(794, "RECORDS");
		...
		IElementType KEYWORD_ZONED = new PlSqlTokenType(836, "ZONED");
		...
		IElementType KEYWORD_LDTRIM = new PlSqlTokenType(826, "LDTRIM");
		IElementType KEYWORD_SQL = new PlSqlTokenType(654, "SQL");
		IElementType KEYWORD_DISCARDFILE = new PlSqlTokenType(813, "DISCARDFILE");
		...
		IElementType KEYWORD_LOCATION = new PlSqlTokenType(838, "LOCATION");
		...
		IElementType KEYWORD_READSIZE = new PlSqlTokenType(816, "READSIZE");
		...
		IElementType KEYWORD_RTRIM = new PlSqlTokenType(825, "RTRIM");
		...
		IElementType KEYWORD_CONCAT = new PlSqlTokenType(839, "CONCAT");
		...
		IElementType KEYWORD_VARRAW = new PlSqlTokenType(830, "VARRAW");
		...
		IElementType KEYWORD_PIPELINED = new PlSqlTokenType(713, "PIPELINED");
		...
		IElementType KEYWORD_WHITESPACE = new PlSqlTokenType(851, "WHITESPACE");
		...
		IElementType KEYWORD_OPTIONALLY = new PlSqlTokenType(852, "OPTIONALLY");
		...
		IElementType KEYWORD_LOAD = new PlSqlTokenType(809, "LOAD");
		...
		IElementType KEYWORD_DATA = new PlSqlTokenType(848, "DATA");
		...
		IElementType KEYWORD_ORACLE_NUMBER = new PlSqlTokenType(833, "ORACLE_NUMBER");
		...
		IElementType KEYWORD_PARALLEL_ENABLE = new PlSqlTokenType(714, "PARALLEL_ENABLE");
		...
		IElementType KEYWORD_FIELD = new PlSqlTokenType(821, "FIELD");
		IElementType KEYWORD_REPLACE = new PlSqlTokenType(458, "REPLACE");
		IElementType KEYWORD_ORACLE_DATE = new PlSqlTokenType(834, "ORACLE_DATE");
		IElementType KEYWORD_NOPARALLEL = new PlSqlTokenType(575, "NOPARALLEL");
		IElementType KEYWORD_STRING = new PlSqlTokenType(806, "STRING");
		...
		IElementType KEYWORD_NOLOGFILE = new PlSqlTokenType(814, "NOLOGFILE");
		IElementType KEYWORD_IDENTIFIED = new PlSqlTokenType(515, "IDENTIFIED");
		IElementType KEYWORD_AFTER = new PlSqlTokenType(516, "AFTER");
		IElementType KEYWORD_TIMEZONE = new PlSqlTokenType(853, "TIMEZONE");
		...
		IElementType KEYWORD_PARAMETERS = new PlSqlTokenType(795, "PARAMETERS");
		IElementType KEYWORD_FIELDS = new PlSqlTokenType(819, "FIELDS");
		IElementType KEYWORD_ENABLED = new PlSqlTokenType(843, "ENABLED");
		...
		IElementType KEYWORD_COMPATIBLE = new PlSqlTokenType(847, "COMPATIBLE");
		IElementType KEYWORD_DATE_FORMAT = new PlSqlTokenType(829, "DATE_FORMAT");
		...
		IElementType KEYWORD_LOGFILE = new PlSqlTokenType(815, "LOGFILE");
		IElementType KEYWORD_LOBFILE = new PlSqlTokenType(840, "LOBFILE");
		...
		IElementType KEYWORD_COUNTED = new PlSqlTokenType(835, "COUNTED");
		...
		IElementType KEYWORD_AGGREGATE = new PlSqlTokenType(793, "AGGREGATE");
		...
		IElementType KEYWORD_COMPRESSION = new PlSqlTokenType(842, "COMPRESSION");
		...
		IElementType KEYWORD_LANGUAGE = new PlSqlTokenType(710, "LANGUAGE");
		IElementType KEYWORD_POSITION = new PlSqlTokenType(827, "POSITION");
		IElementType KEYWORD_NOTRIM = new PlSqlTokenType(823, "NOTRIM");
		IElementType KEYWORD_BYTES = new PlSqlTokenType(808, "BYTES");
		...
		IElementType KEYWORD_DETERMINISTIC = new PlSqlTokenType(715, "DETERMINISTIC");
		...
		IElementType KEYWORD_UNSIGNED = new PlSqlTokenType(837, "UNSIGNED");
		IElementType KEYWORD_ACCESS = new PlSqlTokenType(796, "ACCESS");
		IElementType KEYWORD_TRANSFORMS = new PlSqlTokenType(854, "TRANSFORMS");
		...
		IElementType KEYWORD_TERMINATED = new PlSqlTokenType(850, "TERMINATED");
		...
		IElementType KEYWORD_MASK = new PlSqlTokenType(849, "MASK");
		IElementType KEYWORD_LITTLE = new PlSqlTokenType(802, "LITTLE");
		IElementType KEYWORD_SHOW = new PlSqlTokenType(426, "SHOW");
		IElementType KEYWORD_SKIP = new PlSqlTokenType(817, "SKIP");
		...
		IElementType KEYWORD_ENCRYPTION = new PlSqlTokenType(845, "ENCRYPTION");
		...
		IElementType KEYWORD_VARCHARC = new PlSqlTokenType(831, "VARCHARC");
		IElementType KEYWORD_GLOBAL = new PlSqlTokenType(459, "GLOBAL");
		IElementType KEYWORD_MARK = new PlSqlTokenType(804, "MARK");
		...
		IElementType KEYWORD_LTRIM = new PlSqlTokenType(824, "LTRIM");
