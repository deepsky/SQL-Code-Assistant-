...
public interface PlSqlBaseTokenTypes {
		...
		IElementType KEYWORD_REFERENCING = new PlSqlTokenType(537, "REFERENCING");
		...
		IElementType KEYWORD_WAIT = new PlSqlTokenType(844, "WAIT");
		IElementType KEYWORD_PCTFREE = new PlSqlTokenType(569, "PCTFREE");
		IElementType KEYWORD_FLOAT = new PlSqlTokenType(692, "FLOAT");
		IElementType KEYWORD_LRTRIM = new PlSqlTokenType(808, "LRTRIM");
		IElementType KEYWORD_MISSING = new PlSqlTokenType(806, "MISSING");
		IElementType KEYWORD_REFERENCES = new PlSqlTokenType(420, "REFERENCES");
		IElementType KEYWORD_TIME = new PlSqlTokenType(677, "TIME");
		IElementType KEYWORD_OVER = new PlSqlTokenType(745, "OVER");
		IElementType KEYWORD_CHARACTERSET = new PlSqlTokenType(786, "CHARACTERSET");
		IElementType KEYWORD_MOVEMENT = new PlSqlTokenType(417, "MOVEMENT");
		IElementType KEYWORD_ROLE = new PlSqlTokenType(384, "ROLE");
		IElementType KEYWORD_LOGON = new PlSqlTokenType(521, "LOGON");
		IElementType KEYWORD_RIGHT = new PlSqlTokenType(771, "RIGHT");
		IElementType KEYWORD_ELSE = new PlSqlTokenType(665, "ELSE");
		IElementType KEYWORD_HOST = new PlSqlTokenType(444, "HOST");
		IElementType KEYWORD_MONITORING = new PlSqlTokenType(576, "MONITORING");
		IElementType KEYWORD_SAVEPOINT = new PlSqlTokenType(777, "SAVEPOINT");
		...
		IElementType KEYWORD_DIASSOCIATE = new PlSqlTokenType(527, "DIASSOCIATE");
		IElementType KEYWORD_SYSDATE = new PlSqlTokenType(411, "SYSDATE");
		...
		IElementType KEYWORD_EACH = new PlSqlTokenType(536, "EACH");
		IElementType KEYWORD_VIEW = new PlSqlTokenType(370, "VIEW");
		IElementType KEYWORD_BIG = new PlSqlTokenType(787, "BIG");
		...
		IElementType KEYWORD_UNIQUE = new PlSqlTokenType(542, "UNIQUE");
		...
		IElementType KEYWORD_EXCLUSIVE = new PlSqlTokenType(854, "EXCLUSIVE");
		IElementType KEYWORD_BEFORE = new PlSqlTokenType(517, "BEFORE");
		IElementType KEYWORD_SQLERRM = new PlSqlTokenType(730, "SQLERRM");
		IElementType KEYWORD_NOGUARANTEE = new PlSqlTokenType(478, "NOGUARANTEE");
		IElementType KEYWORD_INSTANCES = new PlSqlTokenType(593, "INSTANCES");
		IElementType KEYWORD_NOWAIT = new PlSqlTokenType(849, "NOWAIT");
		IElementType KEYWORD_PREPROCESSOR = new PlSqlTokenType(827, "PREPROCESSOR");
		IElementType KEYWORD_PCTVERSION = new PlSqlTokenType(556, "PCTVERSION");
		IElementType KEYWORD_WRITE = new PlSqlTokenType(490, "WRITE");
		...
		IElementType KEYWORD_SHUTDOWN = new PlSqlTokenType(519, "SHUTDOWN");
		IElementType KEYWORD_MEMBER = new PlSqlTokenType(728, "MEMBER");
		IElementType KEYWORD_SID = new PlSqlTokenType(769, "SID");
		IElementType KEYWORD_DEFINE = new PlSqlTokenType(441, "DEFINE");
		...
		IElementType KEYWORD_ANALYZE = new PlSqlTokenType(523, "ANALYZE");
		IElementType KEYWORD_REF = new PlSqlTokenType(624, "REF");
		IElementType KEYWORD_NEW = new PlSqlTokenType(540, "NEW");
		...
		IElementType KEYWORD_NORMAL = new PlSqlTokenType(486, "NORMAL");
		IElementType KEYWORD_EXCEPTION = new PlSqlTokenType(708, "EXCEPTION");
		IElementType KEYWORD_LEAD = new PlSqlTokenType(736, "LEAD");
		IElementType KEYWORD_BY = new PlSqlTokenType(510, "BY");
		IElementType KEYWORD_LONG = new PlSqlTokenType(425, "LONG");
		IElementType KEYWORD_CLOSE = new PlSqlTokenType(652, "CLOSE");
		IElementType KEYWORD_ANY = new PlSqlTokenType(742, "ANY");
		IElementType KEYWORD_NOBADFILE = new PlSqlTokenType(796, "NOBADFILE");
		IElementType KEYWORD_KEY = new PlSqlTokenType(419, "KEY");
		IElementType KEYWORD_EXECUTE = new PlSqlTokenType(431, "EXECUTE");
		IElementType KEYWORD_PACKAGES = new PlSqlTokenType(395, "PACKAGES");
		IElementType KEYWORD_OSERROR = new PlSqlTokenType(434, "OSERROR");
		IElementType KEYWORD_DOUBLE = new PlSqlTokenType(690, "DOUBLE");
		IElementType KEYWORD_REPHEADER = new PlSqlTokenType(451, "REPHEADER");
		IElementType KEYWORD_AND = new PlSqlTokenType(494, "AND");
		IElementType KEYWORD_COMPRESS = new PlSqlTokenType(564, "COMPRESS");
		IElementType KEYWORD_DELIMITED = new PlSqlTokenType(784, "DELIMITED");
		...
		IElementType KEYWORD_UPDATE = new PlSqlTokenType(535, "UPDATE");
		IElementType KEYWORD_RAW = new PlSqlTokenType(674, "RAW");
		IElementType KEYWORD_CONNECT = new PlSqlTokenType(514, "CONNECT");
		IElementType KEYWORD_NOLOGGING = new PlSqlTokenType(482, "NOLOGGING");
		IElementType KEYWORD_TIMEZONE_HOUR = new PlSqlTokenType(750, "TIMEZONE_HOUR");
		IElementType KEYWORD_SET = new PlSqlTokenType(424, "SET");
		IElementType KEYWORD_VAR = new PlSqlTokenType(427, "VAR");
		IElementType KEYWORD_DATA_CACHE = new PlSqlTokenType(804, "DATA_CACHE");
		IElementType KEYWORD_DDL = new PlSqlTokenType(526, "DDL");
		...
		IElementType KEYWORD_DISABLE = new PlSqlTokenType(414, "DISABLE");
		...
		IElementType KEYWORD_NODISCARDFILE = new PlSqlTokenType(798, "NODISCARDFILE");
		...
		IElementType KEYWORD_ORACLE_LOADER = new PlSqlTokenType(855, "ORACLE_LOADER");
		IElementType KEYWORD_UNIFORM = new PlSqlTokenType(474, "UNIFORM");
		IElementType KEYWORD_AT = new PlSqlTokenType(722, "AT");
		IElementType KEYWORD_AS = new PlSqlTokenType(539, "AS");
		IElementType KEYWORD_AUDIT = new PlSqlTokenType(524, "AUDIT");
		...
		IElementType KEYWORD_OFF = new PlSqlTokenType(450, "OFF");
		IElementType KEYWORD_JAVA = new PlSqlTokenType(714, "JAVA");
		IElementType KEYWORD_DISABLED = new PlSqlTokenType(830, "DISABLED");
		IElementType KEYWORD_MULTISET = new PlSqlTokenType(734, "MULTISET");
		IElementType KEYWORD_ENCLOSED = new PlSqlTokenType(814, "ENCLOSED");
		IElementType KEYWORD_NO = new PlSqlTokenType(483, "NO");
		IElementType KEYWORD_NOCACHE = new PlSqlTokenType(508, "NOCACHE");
		IElementType KEYWORD_PACKAGE = new PlSqlTokenType(364, "PACKAGE");
		IElementType KEYWORD_FIXED = new PlSqlTokenType(785, "FIXED");
		IElementType KEYWORD_OF = new PlSqlTokenType(532, "OF");
		...
		IElementType KEYWORD_ONLY = new PlSqlTokenType(489, "ONLY");
		...
		IElementType KEYWORD_INCREMENT = new PlSqlTokenType(509, "INCREMENT");
		IElementType KEYWORD_COALESCE = new PlSqlTokenType(501, "COALESCE");
		IElementType KEYWORD_FINAL = new PlSqlTokenType(621, "FINAL");
		IElementType KEYWORD_FETCH = new PlSqlTokenType(653, "FETCH");
		IElementType KEYWORD_OR = new PlSqlTokenType(457, "OR");
		IElementType KEYWORD_VARRAWC = new PlSqlTokenType(818, "VARRAWC");
		IElementType KEYWORD_STARTUP = new PlSqlTokenType(518, "STARTUP");
		IElementType KEYWORD_ROW = new PlSqlTokenType(416, "ROW");
		IElementType KEYWORD_MANAGED = new PlSqlTokenType(400, "MANAGED");
		IElementType KEYWORD_NEWLINE = new PlSqlTokenType(783, "NEWLINE");
		IElementType KEYWORD_NOORDER = new PlSqlTokenType(512, "NOORDER");
		IElementType KEYWORD_ENDIAN = new PlSqlTokenType(789, "ENDIAN");
		...
		IElementType KEYWORD_RECORDS = new PlSqlTokenType(780, "RECORDS");
		IElementType KEYWORD_LOGOFF = new PlSqlTokenType(522, "LOGOFF");
		...
		IElementType KEYWORD_CONSTRAINT = new PlSqlTokenType(422, "CONSTRAINT");
		IElementType KEYWORD_PCTTHRESHOLD = new PlSqlTokenType(589, "PCTTHRESHOLD");
		IElementType KEYWORD_QUIT = new PlSqlTokenType(445, "QUIT");
		IElementType KEYWORD_ROWNUM = new PlSqlTokenType(847, "ROWNUM");
		IElementType KEYWORD_AUTOEXTEND = new PlSqlTokenType(479, "AUTOEXTEND");
		IElementType KEYWORD_ZONED = new PlSqlTokenType(822, "ZONED");
		IElementType KEYWORD_NULL = new PlSqlTokenType(406, "NULL");
		IElementType KEYWORD_BACKUP = new PlSqlTokenType(500, "BACKUP");
		IElementType KEYWORD_ROWCOUNT = new PlSqlTokenType(657, "ROWCOUNT");
		IElementType KEYWORD_TRUE = new PlSqlTokenType(719, "TRUE");
		IElementType KEYWORD_LDTRIM = new PlSqlTokenType(812, "LDTRIM");
		IElementType KEYWORD_SQL = new PlSqlTokenType(654, "SQL");
		IElementType KEYWORD_DISCARDFILE = new PlSqlTokenType(799, "DISCARDFILE");
		IElementType KEYWORD_FORCE = new PlSqlTokenType(376, "FORCE");
		IElementType KEYWORD_INSERT = new PlSqlTokenType(534, "INSERT");
		IElementType KEYWORD_TIMEZONE_REGION = new PlSqlTokenType(752, "TIMEZONE_REGION");
		IElementType KEYWORD_LAST = new PlSqlTokenType(841, "LAST");
		...
		IElementType KEYWORD_LOCATION = new PlSqlTokenType(824, "LOCATION");
		...
		IElementType KEYWORD_REVOKE = new PlSqlTokenType(529, "REVOKE");
		...
		IElementType KEYWORD_SPOOL = new PlSqlTokenType(446, "SPOOL");
		IElementType KEYWORD_WHEN = new PlSqlTokenType(541, "WHEN");
		IElementType KEYWORD_PRIMARY = new PlSqlTokenType(418, "PRIMARY");
		IElementType KEYWORD_VALUE = new PlSqlTokenType(552, "VALUE");
		IElementType KEYWORD_ACTION = new PlSqlTokenType(613, "ACTION");
		IElementType KEYWORD_NONE = new PlSqlTokenType(439, "NONE");
		IElementType KEYWORD_FREEPOOLS = new PlSqlTokenType(557, "FREEPOOLS");
		IElementType KEYWORD_RETURNING = new PlSqlTokenType(851, "RETURNING");
		IElementType KEYWORD_CYCLE = new PlSqlTokenType(505, "CYCLE");
		IElementType KEYWORD_MINVALUE = new PlSqlTokenType(504, "MINVALUE");
		...
		IElementType KEYWORD_DATAFILE = new PlSqlTokenType(466, "DATAFILE");
		IElementType KEYWORD_ERROR_CODE = new PlSqlTokenType(662, "ERROR_CODE");
		IElementType KEYWORD_ROWS = new PlSqlTokenType(547, "ROWS");
		IElementType KEYWORD_PERMANENT = new PlSqlTokenType(491, "PERMANENT");
		IElementType KEYWORD_INTERSECT = new PlSqlTokenType(760, "INTERSECT");
		IElementType KEYWORD_DATAFILES = new PlSqlTokenType(495, "DATAFILES");
		IElementType KEYWORD_NOMONITORING = new PlSqlTokenType(577, "NOMONITORING");
		IElementType KEYWORD_SERVEROUTPUT = new PlSqlTokenType(452, "SERVEROUTPUT");
		IElementType KEYWORD_READSIZE = new PlSqlTokenType(802, "READSIZE");
		IElementType KEYWORD_NOSORT = new PlSqlTokenType(616, "NOSORT");
		IElementType KEYWORD_ROLLBACK = new PlSqlTokenType(438, "ROLLBACK");
		IElementType KEYWORD_FROM = new PlSqlTokenType(749, "FROM");
		IElementType KEYWORD_ADD = new PlSqlTokenType(496, "ADD");
		IElementType KEYWORD_ONLINE = new PlSqlTokenType(484, "ONLINE");
		IElementType KEYWORD_WHILE = new PlSqlTokenType(642, "WHILE");
		IElementType KEYWORD_REAL = new PlSqlTokenType(684, "REAL");
		IElementType KEYWORD_EXTENT = new PlSqlTokenType(471, "EXTENT");
		IElementType KEYWORD_IF = new PlSqlTokenType(644, "IF");
		IElementType KEYWORD_RETENTION = new PlSqlTokenType(476, "RETENTION");
		IElementType KEYWORD_READ = new PlSqlTokenType(488, "READ");
		...
		IElementType KEYWORD_REUSE = new PlSqlTokenType(470, "REUSE");
		IElementType KEYWORD_RTRIM = new PlSqlTokenType(811, "RTRIM");
		...
		IElementType KEYWORD_CONCAT = new PlSqlTokenType(825, "CONCAT");
		IElementType KEYWORD_IN = new PlSqlTokenType(558, "IN");
		IElementType KEYWORD_DATABASE = new PlSqlTokenType(387, "DATABASE");
		IElementType KEYWORD_SYSTIMESTAMP = new PlSqlTokenType(412, "SYSTIMESTAMP");
		IElementType KEYWORD_LOCAL = new PlSqlTokenType(473, "LOCAL");
		IElementType KEYWORD_FOUND = new PlSqlTokenType(655, "FOUND");
		IElementType KEYWORD_MATCHED = new PlSqlTokenType(850, "MATCHED");
		IElementType KEYWORD_VARRAW = new PlSqlTokenType(816, "VARRAW");
		IElementType KEYWORD_VARRAY = new PlSqlTokenType(627, "VARRAY");
		IElementType KEYWORD_NULLS = new PlSqlTokenType(839, "NULLS");
		...
		IElementType KEYWORD_SCHEMA = new PlSqlTokenType(530, "SCHEMA");
		...
		IElementType KEYWORD_CONTENTS = new PlSqlTokenType(493, "CONTENTS");
		IElementType KEYWORD_WHITESPACE = new PlSqlTokenType(837, "WHITESPACE");
		...
		IElementType KEYWORD_OPTIONALLY = new PlSqlTokenType(838, "OPTIONALLY");
		IElementType KEYWORD_DECLARE = new PlSqlTokenType(454, "DECLARE");
		...
		IElementType KEYWORD_LOAD = new PlSqlTokenType(795, "LOAD");
		...
		IElementType KEYWORD_MINIMUM = new PlSqlTokenType(502, "MINIMUM");
		IElementType KEYWORD_ORACLE_DATAPUMP = new PlSqlTokenType(856, "ORACLE_DATAPUMP");
		IElementType KEYWORD_NEXT = new PlSqlTokenType(467, "NEXT");
		IElementType KEYWORD_CLOB = new PlSqlTokenType(701, "CLOB");
		IElementType KEYWORD_DATA = new PlSqlTokenType(834, "DATA");
		IElementType KEYWORD_REPFOOTER = new PlSqlTokenType(449, "REPFOOTER");
		...
		IElementType KEYWORD_ORACLE_NUMBER = new PlSqlTokenType(819, "ORACLE_NUMBER");
		...
		IElementType KEYWORD_WHENEVER = new PlSqlTokenType(432, "WHENEVER");
		...
		IElementType KEYWORD_FIELD = new PlSqlTokenType(807, "FIELD");
		IElementType KEYWORD_REPLACE = new PlSqlTokenType(458, "REPLACE");
		IElementType KEYWORD_ORACLE_DATE = new PlSqlTokenType(820, "ORACLE_DATE");
		IElementType KEYWORD_NOPARALLEL = new PlSqlTokenType(575, "NOPARALLEL");
		IElementType KEYWORD_STRING = new PlSqlTokenType(792, "STRING");
		IElementType KEYWORD_PROMPT = new PlSqlTokenType(442, "PROMPT");
		IElementType KEYWORD_VARIABLE = new PlSqlTokenType(428, "VARIABLE");
		IElementType KEYWORD_SHARED_POOL = new PlSqlTokenType(767, "SHARED_POOL");
		IElementType KEYWORD_KEEP = new PlSqlTokenType(606, "KEEP");
		IElementType KEYWORD_TO = new PlSqlTokenType(498, "TO");
		IElementType KEYWORD_COL = new PlSqlTokenType(429, "COL");
		...
		IElementType KEYWORD_NOLOGFILE = new PlSqlTokenType(800, "NOLOGFILE");
		IElementType KEYWORD_IDENTIFIED = new PlSqlTokenType(515, "IDENTIFIED");
		IElementType KEYWORD_AFTER = new PlSqlTokenType(516, "AFTER");
		IElementType KEYWORD_TIMEZONE = new PlSqlTokenType(842, "TIMEZONE");
		IElementType KEYWORD_VALUES = new PlSqlTokenType(581, "VALUES");
		IElementType KEYWORD_NCLOB = new PlSqlTokenType(702, "NCLOB");
		IElementType KEYWORD_COMMIT = new PlSqlTokenType(437, "COMMIT");
		...
		IElementType KEYWORD_LDRTRIM = new PlSqlTokenType(860, "LDRTRIM");
		IElementType KEYWORD_PARAMETERS = new PlSqlTokenType(781, "PARAMETERS");
		IElementType KEYWORD_FIELDS = new PlSqlTokenType(805, "FIELDS");
		IElementType KEYWORD_ENABLED = new PlSqlTokenType(829, "ENABLED");
		IElementType KEYWORD_INDEX = new PlSqlTokenType(375, "INDEX");
		IElementType KEYWORD_BITMAP = new PlSqlTokenType(543, "BITMAP");
		IElementType KEYWORD_STA = new PlSqlTokenType(447, "STA");
		...
		IElementType KEYWORD_MAXSIZE = new PlSqlTokenType(468, "MAXSIZE");
		IElementType KEYWORD_TEMPFILE = new PlSqlTokenType(464, "TEMPFILE");
		IElementType KEYWORD_COMPATIBLE = new PlSqlTokenType(833, "COMPATIBLE");
		IElementType KEYWORD_DATE_FORMAT = new PlSqlTokenType(815, "DATE_FORMAT");
		...
		IElementType KEYWORD_LOGFILE = new PlSqlTokenType(801, "LOGFILE");
		IElementType KEYWORD_LOBFILE = new PlSqlTokenType(826, "LOBFILE");
		...
		IElementType KEYWORD_IMMEDIATE = new PlSqlTokenType(487, "IMMEDIATE");
		IElementType KEYWORD_COUNTED = new PlSqlTokenType(821, "COUNTED");
		IElementType KEYWORD_OPERATIONS = new PlSqlTokenType(567, "OPERATIONS");
		IElementType KEYWORD_LATEST = new PlSqlTokenType(857, "LATEST");
		...
		IElementType KEYWORD_SMALLFILE = new PlSqlTokenType(462, "SMALLFILE");
		IElementType KEYWORD_AGGREGATE = new PlSqlTokenType(779, "AGGREGATE");
		...
		IElementType KEYWORD_COMPRESSION = new PlSqlTokenType(828, "COMPRESSION");
		...
		IElementType KEYWORD_CREATE = new PlSqlTokenType(456, "CREATE");
		IElementType KEYWORD_EXIT = new PlSqlTokenType(435, "EXIT");
		IElementType KEYWORD_NOT = new PlSqlTokenType(413, "NOT");
		...
		IElementType KEYWORD_START = new PlSqlTokenType(448, "START");
		...
		IElementType KEYWORD_POSITION = new PlSqlTokenType(813, "POSITION");
		IElementType KEYWORD_NOTRIM = new PlSqlTokenType(809, "NOTRIM");
		IElementType KEYWORD_BYTES = new PlSqlTokenType(794, "BYTES");
		...
		IElementType KEYWORD_NOCHECK = new PlSqlTokenType(791, "NOCHECK");
		IElementType KEYWORD_OFFLINE = new PlSqlTokenType(485, "OFFLINE");
		IElementType KEYWORD_ESCAPE = new PlSqlTokenType(726, "ESCAPE");
		IElementType KEYWORD_MODE = new PlSqlTokenType(852, "MODE");
		IElementType KEYWORD_VERSION = new PlSqlTokenType(832, "VERSION");
		IElementType KEYWORD_CHARACTER = new PlSqlTokenType(698, "CHARACTER");
		IElementType KEYWORD_BADFILE = new PlSqlTokenType(797, "BADFILE");
		IElementType KEYWORD_EXCEPTIONS = new PlSqlTokenType(717, "EXCEPTIONS");
		IElementType KEYWORD_DEF = new PlSqlTokenType(440, "DEF");
		IElementType KEYWORD_UNION = new PlSqlTokenType(759, "UNION");
		IElementType KEYWORD_DELETE = new PlSqlTokenType(533, "DELETE");
		...
		IElementType KEYWORD_END = new PlSqlTokenType(499, "END");
		IElementType KEYWORD_TRIGGER = new PlSqlTokenType(389, "TRIGGER");
		IElementType KEYWORD_ISOPEN = new PlSqlTokenType(658, "ISOPEN");
		IElementType KEYWORD_RELY = new PlSqlTokenType(421, "RELY");
		IElementType KEYWORD_CACHE = new PlSqlTokenType(507, "CACHE");
		IElementType KEYWORD_RETURN = new PlSqlTokenType(550, "RETURN");
		IElementType KEYWORD_DICTIONARY = new PlSqlTokenType(475, "DICTIONARY");
		IElementType KEYWORD_BIGFILE = new PlSqlTokenType(461, "BIGFILE");
		IElementType KEYWORD_UNSIGNED = new PlSqlTokenType(823, "UNSIGNED");
		IElementType KEYWORD_ACCESS = new PlSqlTokenType(782, "ACCESS");
		IElementType KEYWORD_TRANSFORMS = new PlSqlTokenType(845, "TRANSFORMS");
		IElementType KEYWORD_CURRENT_TIMESTAMP = new PlSqlTokenType(846, "CURRENT_TIMESTAMP");
		IElementType KEYWORD_DEGREE = new PlSqlTokenType(592, "DEGREE");
		IElementType KEYWORD_DIRECTORY = new PlSqlTokenType(385, "DIRECTORY");
		IElementType KEYWORD_TERMINATED = new PlSqlTokenType(836, "TERMINATED");
		IElementType KEYWORD_OLD = new PlSqlTokenType(538, "OLD");
		IElementType KEYWORD_MINEXTENTS = new PlSqlTokenType(598, "MINEXTENTS");
		IElementType KEYWORD_GRANT = new PlSqlTokenType(528, "GRANT");
		IElementType KEYWORD_TRANSACTION = new PlSqlTokenType(778, "TRANSACTION");
		IElementType KEYWORD_UNDO = new PlSqlTokenType(465, "UNDO");
		IElementType KEYWORD_NVARCHAR2 = new PlSqlTokenType(697, "NVARCHAR2");
		IElementType KEYWORD_RENAME = new PlSqlTokenType(497, "RENAME");
		IElementType KEYWORD_ENABLE = new PlSqlTokenType(415, "ENABLE");
		IElementType KEYWORD_MASK = new PlSqlTokenType(835, "MASK");
		IElementType KEYWORD_LITTLE = new PlSqlTokenType(788, "LITTLE");
		IElementType KEYWORD_SHOW = new PlSqlTokenType(426, "SHOW");
		IElementType KEYWORD_SKIP = new PlSqlTokenType(803, "SKIP");
		...
		IElementType KEYWORD_TABLESPACE = new PlSqlTokenType(463, "TABLESPACE");
		IElementType KEYWORD_ENCRYPTION = new PlSqlTokenType(831, "ENCRYPTION");
		...
		IElementType KEYWORD_VARCHARC = new PlSqlTokenType(817, "VARCHARC");
		IElementType KEYWORD_GLOBAL = new PlSqlTokenType(459, "GLOBAL");
		IElementType KEYWORD_MARK = new PlSqlTokenType(790, "MARK");
		IElementType KEYWORD_LOGGING = new PlSqlTokenType(481, "LOGGING");
		...
		IElementType KEYWORD_MANAGEMENT = new PlSqlTokenType(472, "MANAGEMENT");
		IElementType KEYWORD_DENSE_RANK = new PlSqlTokenType(738, "DENSE_RANK");
		IElementType KEYWORD_CHARACTERS = new PlSqlTokenType(858, "CHARACTERS");
		IElementType KEYWORD_REJECT = new PlSqlTokenType(594, "REJECT");
		IElementType KEYWORD_TEMPORARY = new PlSqlTokenType(460, "TEMPORARY");
		IElementType KEYWORD_SERVERERROR = new PlSqlTokenType(520, "SERVERERROR");
		IElementType KEYWORD_OBJECT = new PlSqlTokenType(622, "OBJECT");
		IElementType KEYWORD_MINUTE = new PlSqlTokenType(740, "MINUTE");
		IElementType KEYWORD_SHARE = new PlSqlTokenType(853, "SHARE");
		IElementType KEYWORD_ORDER = new PlSqlTokenType(511, "ORDER");
		IElementType KEYWORD_FULL = new PlSqlTokenType(775, "FULL");
		IElementType KEYWORD_LTRIM = new PlSqlTokenType(810, "LTRIM");
		IElementType KEYWORD_NOTFOUND = new PlSqlTokenType(656, "NOTFOUND");
		IElementType KEYWORD_WITH = new PlSqlTokenType(392, "WITH");
		IElementType KEYWORD_CHECK = new PlSqlTokenType(423, "CHECK");
		IElementType KEYWORD_LOCK = new PlSqlTokenType(650, "LOCK");
		IElementType KEYWORD_THE = new PlSqlTokenType(843, "THE");
		IElementType KEYWORD_SQLERROR = new PlSqlTokenType(433, "SQLERROR");
		IElementType KEYWORD_DECIMAL = new PlSqlTokenType(693, "DECIMAL");
		IElementType KEYWORD_BEGIN = new PlSqlTokenType(453, "BEGIN");
		IElementType KEYWORD_BLOB = new PlSqlTokenType(700, "BLOB");
		IElementType KEYWORD_NOCYCLE = new PlSqlTokenType(506, "NOCYCLE");
		IElementType KEYWORD_OUTER = new PlSqlTokenType(773, "OUTER");
		IElementType KEYWORD_CONTINUE = new PlSqlTokenType(436, "CONTINUE");
		IElementType KEYWORD_INSTEAD = new PlSqlTokenType(531, "INSTEAD");
		IElementType KEYWORD_GUARANTEE = new PlSqlTokenType(477, "GUARANTEE");
		IElementType KEYWORD_CLUSTER = new PlSqlTokenType(562, "CLUSTER");
		IElementType KEYWORD_GROUP = new PlSqlTokenType(480, "GROUP");
		IElementType KEYWORD_FIRST = new PlSqlTokenType(840, "FIRST");
