...
//            errFinish += "else {" + throwNoViable + "}";
            String BAD_CHARACTER_REF_TYPE = System.getProperty("BAD_CHARACTER", "PLSqlTokenTypes.BAD_CHARACTER");
            errFinish += "\t\t\t\telse {\n" +
                    "\t\t\t\t\tif (LA(1)==EOF_CHAR) {\n" +
                    "                        uponEOF(); _returnToken = makeToken(Token.EOF_TYPE);\n" +
                    "                    } else {\n" +
//                    "                        Token __token = makeToken(PLSqlTokenTypes.BAD_CHARACTER);\n" +
                    "                        Token __token = makeToken(" + BAD_CHARACTER_REF_TYPE + ");\n" +
...
//            println("throw new TokenStreamRecognitionException(e);");
            ...
            String BAD_CHARACTER_REF_TYPE = System.getProperty("BAD_CHARACTER", "PLSqlTokenTypes.BAD_CHARACTER");
            println("\t\t\t    Token __token = makeToken(" + BAD_CHARACTER_REF_TYPE +");\n" +
//            println("\t\t\t    Token __token = makeToken(PLSqlTokenTypes.BAD_CHARACTER);\n" +
