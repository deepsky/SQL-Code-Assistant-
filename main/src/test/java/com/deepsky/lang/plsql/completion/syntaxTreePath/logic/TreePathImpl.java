...
public class TreePathImpl implements TreePath {
    ...
    public boolean processPattern(STPPattern[] patterns, SyntaxTreeProcessor processor) {
        ...
        for (STPPattern pattern : patterns) {
            ...
            final List<ArgumentDesc> argList = new ArrayList<ArgumentDesc>();
            ...
            if (!patternIt.hasNext()) {
                ...
                processor.handle(pattern, prefix, argList.toArray(new ArgumentDesc[argList.size()]));
                return true;
            }
        }
    ...
    private boolean equals(PatternElement elem, List<ASTNode> level, ArgumentHandler handler) {
...
//    }
    ...
    private Iterator<List<ASTNode>> iterator() {
