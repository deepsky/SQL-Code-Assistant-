...
import com.deepsky.lang.plsql.completion.syntaxTreePath.generated.SyntaxTreePathTypesTokenTypes;
import com.deepsky.lang.plsql.completion.syntaxTreePath.steps.ASTNodeStep;
import com.deepsky.lang.plsql.completion.syntaxTreePath.steps.AllNodesStep;
import com.deepsky.lang.plsql.completion.syntaxTreePath.steps.PsiElementStep;
    ...
    public static Step parse(@NotNull String stxPath) throws StxParseException {
        ...
        try {
            while (true) {
                ...
                if (t.getType() == SyntaxTreePathTypesTokenTypes.EOF) {
                    break;
                }

                switch (t.getType()) {
                    case SyntaxTreePathTypesTokenTypes.DOUBLE_SLASH:
                        ...
                        break;
                    case SyntaxTreePathTypesTokenTypes.SLASH:
                        if (state != INIT_LOCATION) {
                            throw new Exception();
                        }
                        state = LOCATION_STARTED;
                        paramRef = -1;
                        break;
                    case SyntaxTreePathTypesTokenTypes.NUMBER:
                        ...
                        state = PARAMETER_REF;
                        break;
                    case SyntaxTreePathTypesTokenTypes.SHARP:
                        ...
                        break;
                    case SyntaxTreePathTypesTokenTypes.DOLLAR:
                        if (!(state == LOCATION_STARTED || state == PARAMETER_REF)) {
                            throw new Exception();
                        }
                        ...
                        break;
                    case SyntaxTreePathTypesTokenTypes.IDENTIFIER:
