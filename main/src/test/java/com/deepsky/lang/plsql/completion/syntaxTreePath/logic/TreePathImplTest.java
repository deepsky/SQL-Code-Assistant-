...
public class TreePathImplTest extends AbstractCompletionTest {
    ...
    public void test0() throws TokenStreamException {
        ...
        STPPattern[] stxPattern = new STPPattern[]{STPPatternParser.parse("/#ERROR_TOKEN_A/1#IDENTIFIER")};

        final List<String> resList = new ArrayList<String>();
        boolean result = path.processPattern(stxPattern, new TreePath.SyntaxTreeProcessor() {
            @Override
    ...
    public void test_select_102() throws TokenStreamException {
        ...
        final List<String> resList = new ArrayList<String>();
        boolean result = path.processPattern(stxPattern, new StxPathProcessor(resList));
    ...
    // ---------------------------------------------------------------------
    // ---------------------------------------------------------------------
    class StxPathProcessor implements TreePath.SyntaxTreeProcessor {
