...
*/
    ...
    public void test_number() throws IOException {
        ...
        assertEquals("234", lexer.getTokenText());
        advance_lexer(lexer);
        ...
        assertEquals("PLSQL:NUMBER",lexer.getTokenType().toString());
        assertEquals("99e456", lexer.getTokenText());
        advance_lexer(lexer);
        ...
        assertEquals("PLSQL:NUMBER",lexer.getTokenType().toString());
        assertEquals("90E+78", lexer.getTokenText());
        advance_lexer(lexer);
        ...
        assertEquals("PLSQL:NUMBER",lexer.getTokenType().toString());
        assertEquals("0.99e-89", lexer.getTokenText());
        advance_lexer(lexer);
        ...
        assertEquals("0.99e", lexer.getTokenText());
        advance_lexer(lexer);

        assertEquals("PLSQL:IDENTIFIER",lexer.getTokenType().toString());
        assertEquals("i78", lexer.getTokenText());
        advance_lexer(lexer);
        ...
        assertEquals("PLSQL:NUMBER",lexer.getTokenType().toString());
        assertEquals("5e-1", lexer.getTokenText());
        advance_lexer(lexer);
    }

    void advance_lexer(PlSqlPsiLexer lex){
        lex.advance();
    }
}
