...
import com.deepsky.lang.common.tnsnames.TNSParserDefinition;
import com.deepsky.lang.plsql.psi.PlSqlElementVisitor;

import com.deepsky.lang.plsql.tree.LightFileElement;
import com.deepsky.lang.plsql.tree.LightLeafElement;
import com.deepsky.lang.plsql.tree.LightPsiLeafElement;
import com.deepsky.lang.plsql.tree.LightweightElement;
...
public class TNSNodeBuilder implements PsiBuilder {
    ...
    public TNSNodeBuilder(VirtualFile virtualFile, String input) {
        this(virtualFile.getPath(), input);
        this.virtualFile = virtualFile;
    }

    public TNSNodeBuilder(String fsPath, String input) {
        ParserDefinition parserDefinition = new TNSParserDefinition();
...
//                }
    ...
    public static PsiElement createPsiElement(ASTNode f) {
        final PsiElement psi = TNSParserDefinition.createElement2(f);
...
/*
                ...
                if (itype == TokenType.WHITE_SPACE || itype == TNSTokenTypes.WS || itype == PlSqlTokenTypes.LF
