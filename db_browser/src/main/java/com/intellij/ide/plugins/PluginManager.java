...
public class PluginManager {
    ...
    public static void initPlugins(@Nullable StartupProgress progress) {
        ...
        try {
            System.out.println("BEFORE PLUGINS INIT ==============");
            initializePlugins(progress);
            System.out.println("AFTER PLUGINS INIT ==============");
        }
    ...
    private static void initializePlugins(@Nullable StartupProgress progress) {
        ...
        System.out.println("NUMBER OF PLUGIN_DESC: " + pluginDescriptors.length + "  -------------------");
        ...
        System.out.println("NUMBER OF AVAIL MODULES: " + ourAvailableModules.size() + "  -------------------");
        System.out.println("NUMBER OF PLUGIN DESC RESULT: " + result.size() + "  -------------------");
    ...
    */
    ...
    public static IdeaPluginDescriptorImpl[] loadDescriptors(@Nullable StartupProgress progress) {
        System.out.println("IS LOADING EXT PLIUGINS DISABLED: " + ClassloaderUtil.isLoadingOfExternalPluginsDisabled());
        ...
        System.out.println("PLUGIN PATH: " + PathManager.getPluginsPath());
        System.out.println("PREINTSALLED PLUGIN PATH: " + PathManager.getPreinstalledPluginsPath());
        ...
        System.out.println("LOAD DESC#1: " + result.size() + " PLUGINS_COUNT: " + pluginsCount);
        System.out.println("APPL IS UNIT TEST: " + application.isUnitTestMode());
        ...
        System.out.println("LOAD DESC#2: " + result.size());
        loadDescriptorsFromProperty(result);

        System.out.println("LOAD DESC#3: " + result.size());
        loadDescriptorsFromClassPath(result, fromSources ? progress : null);

        System.out.println("LOAD DESC#4: " + result.size());
    ...
    private static void loadDescriptorsFromClassPath(final List<IdeaPluginDescriptorImpl> result, @Nullable StartupProgress progress) {
        try {
            List<URL> tt = new ArrayList<URL>();
            tt.add(new File("/home/sky/idea-IC-123.72/lib/resources.jar").toURL());
            final Collection<URL> urls = tt; //getClassLoaderUrls();
            final String platformPrefix = System.getProperty("idea.platform.prefix");
            int i = 0;
            System.out.println("NUMBER OF CLASSLOADERS URLS: " + urls.size());
            for (URL url : urls) {
